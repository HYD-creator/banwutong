...
document.addEventListener("submit", async e => {
  ...
  if(e.target.id==='call-student-form'){
    ...
    const call={id:crypto.randomUUID(),studentId:student.id,studentName:student.name,message:String(f.get('message')||'请到讲台'),author:teacherName(),createdAt:new Date().toISOString()};
