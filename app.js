...
const initial = {
  ...
  tasks: DEFAULT_TASKS, draft: {}, published: {}, announcements: [], announcementReceipts: {}, assignments: [], homeworkStatus: {}, homeworkClassroomEnabled: false, homeworkClassroomPin: "", classroomHomeworkUnlocked: false, attendanceRecords: [], draftDirty: false, view: "login", picker: null, modal: null, popover: null,
};
let saved;
